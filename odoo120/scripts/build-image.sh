...
# git-core PPA data
GITCORE_PPA_REPO="deb http://ppa.launchpad.net/git-core/ppa/ubuntu bionic main"
GITCORE_PPA_KEY="http://keyserver.ubuntu.com:11371/pks/lookup?op=get&search=0xA1715D88E1DF1F24"

# ppa sources
VIM_PPA_REPO="deb http://ppa.launchpad.net/jonathonf/vim/ubuntu bionic main"
...
DPKG_DEPENDS="postgresql-10 postgresql-contrib-10 \
...
#collect_pip_dependencies  "${PIP_DEPENDS_EXTRA}" "${DEPENDENCIES_FILE}"
...
# Install xvfb daemon // this does not exist for 20.04
#wget https://raw.githubusercontent.com/travis-ci/travis-cookbooks/bionic-stable/cookbooks/travis_build_environment/files/default/etc-init.d-xvfb.sh -O /etc/init.d/xvfb
